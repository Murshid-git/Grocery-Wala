        ...
        <div className='min-h-screen max-w-[1400px]  mx-auto px-10 flex md:flex-row flex-col items-center md:pt-25 pt-35'>
            ...
            <div className='flex-1'>
                <span className='bg-green-100 text-green-500 text-lg px-5 py-2 rounded-full'>
                    Exports Best Quality...
                </span>
                <h1 className='md:text-7xl/20 text-5xl/14 dont-bold mt-4 '>
                    Tasty Organic <span className='text-green-500 max-w-[530px] mt-5 mb-10'>Fruits</span> & <span className='text-orange-400'>Vaggies</span> <br /> In Your City
                </h1>
